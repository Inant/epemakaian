...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        // Monitoring piutang
        Route::get('monitoring-piutang', 'Transaction\MonitoringPiutangController@index')->name('monitoringpiutang.index');
        ...
        Route::get('report/piutang-pertahun', 'Statis\ReportController@piutang_pertahun')->name('report.piutang_pertahun');
