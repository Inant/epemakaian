    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div id="grafik_penerimaan" style="height: 250px;"></div>
                    </div>
                {{-- <div class="col-auto">
                    <div class="icon icon-shape bg-gradient-green text-white rounded-circle shadow">
                        <i class="ni ni-money-coins"></i>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div id="grafik_piutang" style="height: 250px;"></div>
                    </div>
                {{-- <div class="col-auto">
                    <div class="icon icon-shape bg-gradient-green text-white rounded-circle shadow">
                        <i class="ni ni-money-coins"></i>
    ...
    //   console.log('qqq');
            ...
            Morris.Line({
                ...
                data: [
                    ...
                    { year: '2013', value: 2500, a: 1500, b: 500, c: 1500 },
                    { year: '2014', value: 1000, a: 2000, b: 2500, c: 1500 },
                    { year: '2015', value: 0, a: 2500, b: 1000 ,c:500},
                    { year: '2016', value: 1000, a: 2000, b: 1500,c:0 }
                ], //supply the response data (which is now a JS variable) directly, no extra brackets
                xkey: 'year',
                ykeys: ['value','a','b','c'],
                //   ymax: 'auto[30]',
